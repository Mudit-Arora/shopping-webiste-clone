...
public class CreateCustomerAccount {
	...
	CreateCustomerAccount(){
		...
		JLabel ePosi = new JLabel("Address  :");
		ePosi.setFont(f);
		ePosi.setBounds(50, 550, 150, 75);
		
		//JButton register = new JButton("Register");
		//register.setFont(f);
		//register.setBounds(50, 650, 150, 75);
					...
					if((userFN.length() == 0)||(userLN.length() == 0)||(userUN.length() == 0)||(userPW.length() == 0)||
						...
						try 
						{
							...
							String sql = "INSERT INTO cust("
									...
									+ userAD + "')";
							stmt.executeQuery("select * from cust;");
